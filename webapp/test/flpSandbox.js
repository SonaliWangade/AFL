		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Value Help",
									"targetURL": "#comibsplvaluehelp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsplvaluehelp-display": {
								"semanticObject": "comibsplvaluehelp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibspl.valuehelp",
									"url": sap.ui.require.toUrl("com/ibspl/valuehelp")
								}
							}
						}
					}
